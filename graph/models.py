...
class Record(models.Model):
    timestamp = models.DecimalField(max_digits=5, decimal_places=2)
    ...
    sensor_name = models.CharField(max_length=200, default='sensor')
    #user = models.ForeignKey(User, models.SET_NULL, blank=True, null=True)
    ...
    @classmethod
    @sync_to_async
    def create(cls, timestamp, data_value, tool_used, sensor_name):
        record = cls(timestamp=timestamp, data_value=data_value, tool_used=tool_used, sensor_name=sensor_name)
        return record
